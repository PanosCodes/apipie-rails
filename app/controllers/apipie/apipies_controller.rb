    ...
    def index
      ...
      respond_to do |format|
        ...
        if should_render_swagger
          prev_warning_value = Apipie.configuration.swagger2.suppress_warnings
          begin
            Apipie.configuration.swagger2.suppress_warnings = true
            @doc = Apipie.to_swagger_json(params[:version], params[:resource], params[:method], @language)
          ensure
            Apipie.configuration.swagger2.suppress_warnings = prev_warning_value
          end
        else
